...
\section{有限平面內的交比}
不包含無窮遠點的平面稱為有限平面，本章節的討論限定在有限平面內。
\subsection{交比定理（有限平面）}
...
\begin{mybox}{4.5em}{1em}{0.5em}
    ...
    \end{align*}
\end{mybox}
\begin{mybox}[性質1的推論]{7.5em}{1em}{0.5em}
    s函數的交換性：$s\left(AB;Q,P\right)=s\left(AB;P,Q\right)=s\left(PQ;A,B\right)=s\left(PQ;B,A\right)$；
\end{mybox}
\begin{mybox}[性質2]{4.5em}{1em}{0.5em}
    設$A$、$B$、$P$、$Q$和$R$五點共線於$\ell$或共圓於$\Gamma$，則有以下關係成立：
    $$
        s\left(AB;P,R\right)/s\left(AB;Q,R\right)=s\left(AB;P,R\right)\cdot s\left(AB;Q,R\right)=s\left(AB;P,Q\right)
    $$
    稱為\underline{$s$函數的異或性}。（此性質證明太容易，讀者自行證明即可）
\end{mybox}
\begin{mybox}[性質3]{4.5em}{1em}{0.5em}
    端點-分點倒數性：$\left(A,B;P,Q\right)=\left(A,B;Q,P\right)^{-1}=\left(B,A;P,Q\right)^{-1}$；
\end{mybox}
\begin{mybox}{4.5em}{1em}{0.5em}
    同樣按照性質1證明的原則去選取$K$點，利用交比定理可得
    \begin{align*}
...
\begin{mybox}{4.5em}{1em}{0.5em}
    ...
    \begin{align*}
        ...
        \cdot\frac{\sin{\measuredangle{\overrightarrow{AKP}}}/\sin{\measuredangle{\overrightarrow{AKQ}}}}{\sin{\measuredangle{\overrightarrow{PKB}}}/\sin{\measuredangle{\overrightarrow{QKB}}}}\\
...
\begin{mybox}[性質4的其他情況]{9.5em}{1em}{0.5em}
    關於性質4，點列$\left(A,B,P,Q\right)$與點列$\left(A',B',P',Q'\right)$還有其他不同的分佈情況，任何一種情況都滿足線-線射影不變性。
...
\end{mybox}
\begin{mybox}{4.5em}{1em}{0.5em}
證明與性質4的證明一致，讀者可以自行驗證其正確性。
\end{mybox}
\begin{mybox}[性質5的其他情況]{9.5em}{1em}{0.5em}
關於性質5，點列$\left(A,B,P,Q\right)$與點列$\left(A',B',P',Q'\right)$還有其他不同的分佈情況，任何一種情況都滿足線-圓射影不變性。
以下列舉四種不同的情況，讀者可以自行驗證其正確性。
\end{mybox}
\begin{figure}[H]
    \centering
...
\begin{mybox}[性質6]{4.5em}{1em}{0.5em}
    （性質5的極限情況）：在任意圓$\Gamma$上任取四個相異點$A'$、$B'$、$P'$、$Q'$，任取直線$\ell$，
...
\begin{mybox}{4.5em}{1em}{0.5em}
    由性質1及定理1可知
    $$
        \left(A,B;P,Q\right)=\frac{\sin{\measuredangle{\overrightarrow{AA'P}}}/\sin{\measuredangle{\overrightarrow{PA'B}}}}{\sin{\measuredangle{\overrightarrow{AA'Q}}}/\sin{\measuredangle{\overrightarrow{QA'B}}}}
    $$
    利用性質4的證明過程中所定義的$g$函數可知
    \begin{align*}
        \sin{\measuredangle{\overrightarrow{AA'P}}}&=(-1)^{g\left(PP';A'\right)}\sin{\measuredangle{\overrightarrow{AA'P'}}}\\
        \sin{\measuredangle{\overrightarrow{PA'B}}}&=(-1)^{g\left(PP';A'\right)+g\left(BB';A'\right)}\sin{\measuredangle{\overrightarrow{P'A'B'}}}\\
        \sin{\measuredangle{\overrightarrow{AA'Q}}}&=(-1)^{g\left(QQ';A'\right)}\sin{\measuredangle{\overrightarrow{AA'Q'}}}\\
        \sin{\measuredangle{\overrightarrow{QA'B}}}&=(-1)^{g\left(QQ';A'\right)+g\left(BB';A'\right)}\sin{\measuredangle{\overrightarrow{Q'A'B'}}}
    \end{align*}
    所以有
    \begin{align*}
        \left(A,B;P,Q\right)&=\frac{(-1)^{g\left(PP';A'\right)-g\left(PP';A'\right)-g\left(BB';A'\right)}}{(-1)^{g\left(QQ';A'\right)-g\left(QQ';A'\right)-g\left(BB';A'\right)}}
        \cdot\frac{\sin{\measuredangle{\overrightarrow{AA'P'}}}/\sin{\measuredangle{\overrightarrow{P'A'B'}}}}{\sin{\measuredangle{\overrightarrow{AA'Q'}}}/\sin{\measuredangle{\overrightarrow{Q'A'B'}}}}\\
        &=\frac{\sin{\measuredangle{\overrightarrow{AA'P'}}}/\sin{\measuredangle{\overrightarrow{P'A'B'}}}}{\sin{\measuredangle{\overrightarrow{AA'Q'}}}/\sin{\measuredangle{\overrightarrow{Q'A'B'}}}}
    \end{align*}
    記$M'\in\left\{P',Q'\right\}$滿足$\angle{AA'M'}=\min{\left(\angle{AA'P'},\angle{AA'Q'}\right)}$，記$N'\in\left\{P',Q'\right\}\setminus\left\{M'\right\}$。

    在弧$A'M'N'$內的弧$A'M'$上任取一點$K\notin\left\{A',M'\right\}$，則有
    \begin{align*}
        \measuredangle{\overrightarrow{AA'P'}}&=\measuredangle{\overrightarrow{A'KP'}}+\pi\\
        \measuredangle{\overrightarrow{P'A'B'}}&=\measuredangle{\overrightarrow{P'KB'}}+\frac{s\left(P'B';A',K\right)-1}{2}\pi\\
        \measuredangle{\overrightarrow{AA'Q'}}&=\measuredangle{\overrightarrow{A'KQ'}}+\pi\\
        \measuredangle{\overrightarrow{Q'A'B'}}&=\measuredangle{\overrightarrow{Q'KB'}}+\frac{s\left(Q'B';A',K\right)-1}{2}\pi
    \end{align*}
    代入至正弦函數中可得
    \begin{align*}
        \sin{\measuredangle{\overrightarrow{AA'P'}}}&=-\sin{\measuredangle{\overrightarrow{A'KP'}}}\\
        \sin{\measuredangle{\overrightarrow{P'A'B'}}}&=s\left(P'B';A',K\right)\sin{\measuredangle{\overrightarrow{P'KB'}}}\\
        \sin{\measuredangle{\overrightarrow{AA'Q'}}}&=-\sin{\measuredangle{\overrightarrow{A'KQ'}}}\\
        \sin{\measuredangle{\overrightarrow{Q'A'B'}}}&=s\left(Q'B';A',K\right)\sin{\measuredangle{\overrightarrow{Q'KB'}}}
    \end{align*}
    此時有
    \begin{align*}
        \left(A,B;P,Q\right)&=\frac{\sin{\measuredangle{\overrightarrow{A'KP'}}}/\sin{\measuredangle{\overrightarrow{P'KB'}}}}{\sin{\measuredangle{\overrightarrow{A'KQ'}}}/\sin{\measuredangle{\overrightarrow{Q'K'B'}}}}\cdot\frac{s\left(P'B';A',K\right)}{s\left(Q'B';A',K\right)}\\
        &=\left(A',B';P',Q'\right)\cdot\frac{s\left(P'B';A',K\right)}{s\left(Q'B';A',K\right)}
    \end{align*}
    由性質1的推論及性質2可知
    $$
        \frac{s\left(P'B';A',K\right)}{s\left(Q'B';A',K\right)}=\frac{s\left(A'K;P',B'\right)}{s\left(A'K;Q',B'\right)}=s\left(A'K;P',Q'\right)
    $$
    由$K$點的選取方式可知，$A'$、$K$、$M'$和$N'$沿一個時針方向依次排列，所以$s\left(A'K;M',N'\right)=1$，因此有$s\left(A'K;P',Q'\right)=1$。
    
    由此可得
    \begin{align*}
        \left(A,B;P,Q\right)&=\left(A',B';P',Q'\right)\cdot\frac{s\left(P'B';A',K\right)}{s\left(Q'B';A',K\right)}\\
        &=\left(A',B';P',Q'\right)\cdot s\left(A'K;P',Q'\right)\\
        &=\left(A',B';P',Q'\right)
    \end{align*}
\end{mybox}
\section{擴展平面內的交比}
包含無窮遠點的平面稱為擴展平面。為了使得交比的應用能夠更加廣泛，必須要把「無窮遠點」也加入至交比的領域當中。
\subsection{無窮遠點}
故名思義，無窮遠點是一個存在於無窮遠處的點。對於空間上任一條直線，「無窮遠點$\infty$」皆在直線上。
在歐氏幾何中，一對平行線永不相交，但是在射影幾何中，一對平行線是會相交於「無窮遠點$\infty$」的。
\begin{mybox}[數值定義]{6em}{1em}{0.5em}
    對於任意兩點$A$、$B$，無窮遠點$\infty$的有向分割比為
    $$
        \overrightarrow{A\infty}/\overrightarrow{\infty B}=-1
    $$
    詳細定義請參考\url{https://en.wikipedia.org/wiki/Point_at_infinity}。
\end{mybox}

對於共線的四點$A$、$B$、$P$和$Q$，
無論我們把$Q$點沿$\overrightarrow{AB}$的正方向或是反方向推移至無窮遠處，$\overrightarrow{AQ}/\overrightarrow{QB}$的值是趨向於$-1$的，如圖\ref{fig:cr_right_infinity}和圖\ref{fig:cr_left_infinity}所示。
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-5/0/C, -4/0/A, 2/0/B, 0/0/P, 4/0/Q, 7/0/D}
            \tkzDefPoints{5/-1/Q', 9/-1/D'}
            \tkzDrawSegment[black, thick, ->](Q',D')
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzLabelPoints[below](A,B,P,Q)
        \end{tikzpicture}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-5/0/C, -4/0/A, 2/0/B, 0/0/P, 8/0/Q, 7/0/D}
            \tkzDefPoints{9/-1/Q', 13/-1/D'}
            \tkzDrawSegment[black, thick, ->](Q',D')
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzLabelPoints[below](A,B,P,Q)
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-5/0/C, -4/0/A, 2/0/B, 0/0/P, 13/0/Q, 7/0/D}
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzDrawSegment[black, thick, dashed](D,Q)
            \tkzLabelPoints[below](A,B,P)
            \tkzLabelPoint[below](Q){$Q=\infty$}
        \end{tikzpicture}
    \end{subfigure}
    \caption{將$Q$點沿$\overrightarrow{AB}$方向推移至無窮遠}
    \label{fig:cr_right_infinity}
\end{figure}
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-7/0/C, -2/0/A, 4/0/B, 0/0/P, -4/0/Q, 5/0/D}
            \tkzDefPoints{-5/-1/Q', -9/-1/C'}
            \tkzDrawSegment[black, thick, ->](Q',C')
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzLabelPoints[below](A,B,P,Q)
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-7/0/C, -2/0/A, 4/0/B, 0/0/P, -7/0/Q, 5/0/D}
            \tkzDefPoints{-8/-1/Q', -12/-1/C'}
            \tkzDrawSegment[black, thick, ->](Q',C')
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzLabelPoints[below](A,B,P,Q)
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \begin{tikzpicture}[scale=0.25]
            \tkzDefPoints{-7/0/C, -2/0/A, 4/0/B, 0/0/P, -12/0/Q, 5/0/D}
            \tkzDrawPoints[fill=black](A,B,P,Q)
            \tkzDrawLines[black, thick](C,D)
            \tkzDrawSegment[black, thick, dashed](C,Q)
            \tkzLabelPoints[below](A,B,P)
            \tkzLabelPoint[below](Q){$Q=\infty$}
        \end{tikzpicture}
    \end{subfigure}
    \caption{將$Q$點沿$\overrightarrow{BA}$方向推移至無窮遠}
    \label{fig:cr_left_infinity}
\end{figure}
$A$、$B$、$P$和$Q(=\infty)$的交比均為
$$
    \left(A,B;P,\infty\right)=\frac{\overrightarrow{AP}/\overrightarrow{PB}}{\overrightarrow{A\infty}/\overrightarrow{\infty B}}=-\frac{\overrightarrow{AP}}{\overrightarrow{PB}}
$$
按照上述結論，直線任一端的無窮遠點與其餘三點所形成的交比均是一致的，所以我們只需要討論直線任一側的無窮遠點即可。
\subsection{有向分比定理（存在無窮遠點）}
\begin{mybox}[定理 3]{4.5em}{1em}{0.5em}
    對於直線 $AB$ 及其外的任意一點 $K$，作一條平行於 $AB$ 的直線 $KQ'$，則有
    $$
        -1=\frac{\overrightarrow{A\infty}}{\overrightarrow{\infty B}}
        =\frac{KA}{KB}\cdot\frac{\sin{\measuredangle{\overrightarrow{AKQ'}}}}{\sin{\measuredangle{\overrightarrow{Q'KB}}}}
    $$
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[scale = 1.2]
            \tkzDefPoints{0/0/K, -1/-2/A, 0.5/-2/P, 3/-2/B, 6/-2/C, 2/0/Q', 6/0/D}
            \tkzDrawPoints[fill=black](A,B,Q',K,C,D)
            \tkzDrawLines[black, thick](A,B K,Q' K,A K,B)
            \tkzLabelPoints[above right](B,Q')
            \tkzLabelPoints[above left](A)
            \tkzLabelPoint[above right](K){$K$}
            %\tkzLabelLine[below, pos=1.2](K,A){$\ell_1$}
            %\tkzLabelLine[below, pos=1.2](K,B){$\ell_2$}
            %\tkzLabelLine[below, pos=1.2](K,P){$\ell_3$}
            %\tkzLabelLine[left, pos=-0.2](K,Q'){$\ell_4$}
            %\tkzLabelLine[left, pos=-0.2](A,B){$\ell'$}
            %\tkzPicAngle[draw=red, thick, ->, angle radius = 20](A,K,P)
            %\tkzPicAngle[draw=red, thick, ->, angle radius = 25](P,K,B)
            \tkzPicAngle[draw=blue, thick, ->, angle radius = 30](A,K,Q')
            \tkzPicAngle[draw=blue, thick, <-, angle radius = 35](B,K,Q')
            \tkzDrawSegment[black, thick, dashed](Q',D)
            \tkzDrawSegment[black, thick, dashed](B,C)
            \tkzLabelPoint[right](C){$Q=\infty$}
            \tkzLabelPoint[right](D){$Q=\infty$}
        \end{tikzpicture}
        \caption{有向分比定理（含無窮遠點）}
        \label{fig:dr_infty}
    \end{figure}
\end{mybox}
\begin{mybox}[解釋]{4em}{1em}{0.5em}
    把無窮遠點$\infty$用符號$Q$表示，利用一般的有向分比定理可知
    $$
        \frac{\overrightarrow{AQ}}{\overrightarrow{QB}}=\frac{KA}{KB}\cdot\frac{\sin{\measuredangle{\overrightarrow{AKQ}}}}{\sin{\measuredangle{\overrightarrow{QKB}}}}
    $$
    再者有
    \begin{align*}
        \measuredangle{\overrightarrow{AKQ}} &= \measuredangle{\overrightarrow{AKQ'}}+ \measuredangle{\overrightarrow{Q'KQ}} \\
        \measuredangle{\overrightarrow{QKB}} &= \measuredangle{\overrightarrow{Q'KB}}+ \measuredangle{\overrightarrow{QKQ'}}
    \end{align*}
    且 $\measuredangle{\overrightarrow{Q'KQ}}=\measuredangle{\overrightarrow{QKQ'}}=\pi$或$0$，所以有
    $$
        \frac{\sin{\measuredangle{\overrightarrow{AKQ}}}}{\sin{\measuredangle{\overrightarrow{QKB}}}}
        =\frac{\sin{\measuredangle{\overrightarrow{AKQ'}}}}{\sin{\measuredangle{\overrightarrow{Q'KB}}}}
    $$
    由此可見，有向分比定理亦適用於分點為無窮遠點的情況。
\end{mybox}
\begin{mybox}{4em}{1em}{0.5em}
    只需要完成以下證明即可：
    $$
        \frac{KA}{KB} = -\frac{\sin{\measuredangle{\overrightarrow{Q'KB}}}}{\sin{\measuredangle{\overrightarrow{AKQ'}}}}
    $$
    首先，對 $\triangle{KAB}$ 使用正弦定理可知
    $$
        \frac{AK}{KB} = \frac{\sin{\measuredangle{\overrightarrow{ABK}}}}{\sin{\measuredangle{\overrightarrow{KAB}}}} = 
        \frac{\sin{\measuredangle{\left(\overrightarrow{BA},\overrightarrow{BK}\right)}}}{\sin{\measuredangle{\left(\overrightarrow{AK},\overrightarrow{AB}\right)}}} 
        = -\frac{\sin{\measuredangle{\left(\overrightarrow{AB},\overrightarrow{KB}\right)}}}{\sin{\measuredangle{\left(\overrightarrow{KA},\overrightarrow{AB}\right)}}}
    $$
    然後，上式最右式的有向角可拆解為
    \begin{align*}
        \measuredangle{\left(\overrightarrow{AB},\overrightarrow{KB}\right)} &= \measuredangle{\left(\overrightarrow{AB},\overrightarrow{KQ'}\right)} + \measuredangle{\left(\overrightarrow{KQ'},\overrightarrow{KB}\right)} = \measuredangle{\left(\overrightarrow{AB},\overrightarrow{KQ'}\right)} + \measuredangle{\overrightarrow{Q'KB}}\\
        \measuredangle{\left(\overrightarrow{KA},\overrightarrow{AB}\right)} &= \measuredangle{\left(\overrightarrow{KA},\overrightarrow{KQ'}\right)} + \measuredangle{\left(\overrightarrow{KQ'},\overrightarrow{AB}\right)} = \measuredangle{\overrightarrow{AKQ'}} + \measuredangle{\left(\overrightarrow{KQ'},\overrightarrow{AB}\right)}
    \end{align*}
    因為 $AB \parallel KQ'$，所以有 $\left(\overrightarrow{AB}, \overrightarrow{KQ'}\right) = \left(\overrightarrow{KQ'}, \overrightarrow{AB}\right) = \pi$ 或 $0$，因此有
    $$
    \frac{\measuredangle{\left(\overrightarrow{AB},\overrightarrow{KB}\right)}}{\measuredangle{\left(\overrightarrow{KA},\overrightarrow{AB}\right)}} = \frac{\sin{\measuredangle{\overrightarrow{Q'KB}}}}{\sin{\measuredangle{\overrightarrow{AKQ'}}}}
    $$
    即
    $$
        \frac{KA}{KB} = -\frac{\sin{\measuredangle{\left(\overrightarrow{AB},\overrightarrow{KB}\right)}}}{\sin{\measuredangle{\left(\overrightarrow{KA},\overrightarrow{AB}\right)}}} = -\frac{\sin{\measuredangle{\overrightarrow{Q'KB}}}}{\sin{\measuredangle{\overrightarrow{AKQ'}}}}
    $$
\end{mybox}
\subsection{交比定理（存在無窮遠點）}
\begin{mybox}[定理 4]{4.5em}{1em}{0.5em}
    在平面內任取一點$K$及四條通過$K$點的相異直線$\ell_1$、$\ell_2$、$\ell_3$和$\ell_4$。
    任取一條平行於$\ell_4$的直線$\ell$，使其與直線$\ell_1$、$\ell_2$和$\ell_3$相交於$A$、$B$和$P$三點。
    在直線$\ell_4$上任取一點$Q'\neq K$，則線分比滿足
    $$
        \left(A,B;P,\infty\right)
        =\frac{\sin{\textcolor{red}{\measuredangle{\overrightarrow{AKP}}}}/\sin{\textcolor{red}{\measuredangle{\overrightarrow{PKB}}}}}
        {\sin{\textcolor{blue}{\measuredangle{\overrightarrow{AKQ'}}}}/\sin{\textcolor{blue}{\measuredangle{\overrightarrow{Q'KB}}}}}
    $$
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[scale = 1.2]
            \tkzDefPoints{0/0/K, -1/-2/A, 0.5/-2/P, 3/-2/B, 6/-2/C, 2/0/Q', 6/0/D}
            \tkzDrawPoints[fill=black](A,B,P,Q',K,C,D)
            \tkzDrawLines[black, thick](A,B K,Q' K,A K,B K,P)
            \tkzLabelPoints[above right](B,Q')
            \tkzLabelPoints[above left](A,P)
            \tkzLabelPoint[above right](K){$K$}
            \tkzLabelLine[below, pos=1.2](K,A){$\ell_1$}
        ...
        \end{tikzpicture}
        \caption{線交比定理（含無窮遠點）}
        \label{fig:cr_bundle_Line_infty}
    \end{figure}
\end{mybox}
\begin{mybox}{4em}{1em}{0.5em}
    利用有向分比定理（含定理 3）可得
    $$
        \left(A,B;P,\infty\right)=\frac{\overrightarrow{AP}/\overrightarrow{PB}}{\overrightarrow{A\infty}/\overrightarrow{\infty B}}
        =\frac{\frac{KA}{KB}\cdot\frac{\sin{\measuredangle{\overrightarrow{AKP}}}}{\sin{\measuredangle{\overrightarrow{PKB}}}}}{\frac{KA}{KB}\cdot\frac{\sin{\measuredangle{\overrightarrow{AKQ'}}}}{\sin{\measuredangle{\overrightarrow{Q'KB}}}}}
        =\frac{\sin{\measuredangle{\overrightarrow{AKP}}}/\sin{\measuredangle{\overrightarrow{PKB}}}}{\sin{\measuredangle{\overrightarrow{AKQ'}}}/\sin{\measuredangle{\overrightarrow{Q'KB}}}}
    $$
\end{mybox}
\begin{mybox}[定理 5]{4.5em}{1em}{0.5em}
    在平面內任取一點$K$及四條通過$K$點的相異直線$\ell_1$、$\ell_2$、$\ell_3$和$\ell_4$。
    任取一條平行於$\ell_4$的直線$\ell$，使其與直線$\ell_1$、$\ell_2$和$\ell_3$相交於$A$、$B$和$P$三點。
    再取另一條不通過 $K$ 點的直線 $\ell'$，使其與直線$\ell_1$、$\ell_2$、$\ell_3$和$\ell_4$分別相交於$A'$、$B'$、$P'$和$Q'$四點，則線分比滿足
    $$
        \left(A,B;P,\infty\right)=\left(A',B';P',Q'\right)
    $$
    \begin{figure}[H]
        \centering
        \begin{tikzpicture}[scale = 1.2]
            \tkzDefPoints{0/0/K, -1/-2/A, 0.5/-2/P, 3/-2/B, 6/-2/C, 2/0/Q', 6/0/D, -0.5/-1/A'}
            \tkzInterLL(A',Q')(K,B) \tkzGetPoint{B'}
            \tkzInterLL(A',Q')(K,P) \tkzGetPoint{P'}
            \tkzDrawPoints[fill=black](A,B,P,Q',A',B',P',K,C,D)
            \tkzDrawLines[black, thick](A,B K,Q' K,A K,B K,P A',Q')
            \tkzLabelPoints[above right](B',B,Q')
            \tkzLabelPoints[above left](A',A,P)
            ...
            \tkzLabelPoint[right](D){$Q=\infty$}
        \end{tikzpicture}
        \caption{性質 4 的延伸（含無窮遠點）}
        \label{fig:cr_ll_infty}
    \end{figure}
\end{mybox}
\begin{mybox}{4em}{1em}{0.5em}
    此定理的證明與性質 4 的證明過程完全相同，只需要將定理 1 改為 定理 4 即可。
\end{mybox}
\end{document}