...
下列所有性質的大前提是：\underline{$A$、$B$、$P$和$Q$為同一直線上的四個相異點。}
...
\begin{mybox}[證明4]{4.5em}{1em}{0.5em}
    由有向交比的定義可得
    \begin{equation*}
        \left(A,B;P,Q\right)>0\Leftrightarrow\overrightarrow{AP}/\overrightarrow{PB}\text{和}\overrightarrow{AQ}/\overrightarrow{QB}\text{同正或同負}\Leftrightarrow\text{$P$和$Q$同為線段$AB$的內分點或外分點}
    \end{equation*}
\end{mybox}
...
\begin{mybox}[證明6]{4.5em}{1em}{0.5em}
    ...
    \end{equation*}
\end{mybox}
\begin{mybox}[性質7]{4.5em}{1em}{0.5em}
    ...
    \end{figure}
\end{mybox}
\begin{mybox}[證明7]{4.5em}{1em}{0.5em}
    利用有向分角定理可知
    \begin{equation*}
    ...
    \end{equation*}
\end{mybox}
\begin{mybox}[性質8]{4.5em}{1em}{0.5em}
