...
\begin{mybox}[證明]{4em}{1em}{0.5em}
    ...
    $$
        \tan{\theta_1}=\tan{\theta_2}
    $$
    即$\tan{\measuredangle{\beta\left(l_1,l_2\right)}}$的取值是唯一的。
\end{mybox}
...
\begin{mybox}[集合-集合加法]{8.5em}{1em}{0.5em}
    ...
    $$
        ...
        =\left\{\alpha\pm\beta+360^{\circ}k\left|k\in\mathbb{Z}\right.\right\}
    $$
...
\begin{mybox}[證明]{4em}{1em}{0.5em}
    ...
    當$2\beta\in\mathbb{Z}\setminus\left\{0\right\}$時，$\forall \theta_1,\theta_2\in\beta\measuredangle{\left(\overrightarrow{v_1},\overrightarrow{v_2}\right)}$，由乘法的定義可得
    $$
        \theta_1\equiv\theta_2\left(\text{mod}\ {180^{\circ}\times 2|\beta|}\right)
    $$
    ...
    $$
        \tan{\theta_1}=\tan{\theta_2}
    $$
    即$\tan{\measuredangle{\beta\left(\overrightarrow{v_1},\overrightarrow{v_2}\right)}}$的取值是唯一的。
\end{mybox}
\begin{mybox}[允許2]{4.5em}{1em}{0.5em}
